    ...
    <header className="fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between ">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold">V-cafe</p>
        </Link>
        <div className="flex items-center gap-8">
          ...
          />
          {
            ...
            { user && user.email === "darshantmahajan29@gmail.com" && (
             <Link to={"/createItem"}>
        ...
        <div className="relative">
          ...
          <ul
           ...
           className="flex flex-col">
            ...
            <p className="m-2 px-1 py-1 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base"onClick={logout}> Logout<MdLogout/></p>
          </motion.div>
            )
          }
          </div>
